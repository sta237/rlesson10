...
sims_base +
  geom_segment(aes(xend = index, yend = 1 / theta,
                   color = value < (1 / theta))) +
  geom_point(aes(color = value < 1 / theta), size = 2) +
  scale_colour_discrete(name = "", labels = c("Above mean", "Below mean"))
```
...
sims_base +
  ...
  scale_colour_manual(
    ...
    name = "", labels = c("Above mean", "Below mean"),
  )
```
...
sims_base +
  ...
  scale_fill_brewer(palette = "Dark2", name = "", 
                      labels = c("Above sample median", "Below sample median"))
```
